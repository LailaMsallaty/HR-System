 ...
 Main content -->
        ...
        <div class="content-wrapper">
            <div class="page-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="mb-0">{{trans('main-trans.Dashboard')}}</h4>
                    </div>
                    <div class="col-sm-6">
                            ...
                            <div class="clearfix">
                                <div class="float-left">
                                    <span class="text-danger">
                                        <i class="fa fa-users highlight-icon" style="color: #8b008b" aria-hidden="true"></i>
                                    </span>
                                </div>
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">{{ trans('reports-trans.Employees') }}</p>
                                    <h4>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">{{ trans('reports-trans.Positions') }}</p>
                                    <h4>{{ \App\Position::count() }}
                                    </h4>
                                </div>
                            </div>
                            {{-- <p class="text-muted pt-3 mb-0 mt-2 border-top">
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">{{trans('reports-trans.Departments')}}</p>
                                    <h4>{{ \App\Department::count() }}</h4>
                                </div>
                            </div>
                            {{-- <p class="text-muted pt-3 mb-0 mt-2 border-top">
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">{{trans('reports-trans.Locations')}}</p>
                                    <h4>{{ \App\Location::count() }}</h4>
                                </div>
                            </div>
                            {{-- <p class="text-muted pt-3 mb-0 mt-2 border-top">
            ...
            <div class="row">
                <div class="col-xl-4 mb-30">
                    <div class="card card-statistics h-100">
                        ...
                        <div class="card-body ">
                            <h5 class="card-title">{{ trans('system-trans.Statistics_Employees') }}</h5>
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <div class="d-block d-md-flexx justify-content-between">
                                <div class="d-block">
                                    <h5 class="card-title">{{ trans('system-trans.Statistics_Attendances') }}  </h5>
                                </div>
                                <div class="d-block" style="width:100%;">
                                    {!! $chartjs2->render() !!}
