...
@section('title')
{{trans('tasks-trans.Show_Receive_Task')}}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0" style="font-family: 'Cairo', sans-serif;color: #8b008b">{{trans('tasks-trans.Show_Receive_Task')}}
               / {{$employeename}} </h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                ...
                <li class="breadcrumb-item active">
                    <a href="{{url('ShowReceiveTask')}}/{{ $employeename }}/{{$filename}}/{{$Employee_Task->id}}">{{trans('tasks-trans.Show_Receive_Task')}}</a>
                </li>
            </ol>
        </div>
    </div>
...
<br>
               ...
               <iframe  src="{{url('attachments/ReceivingEmployeeTasks/'.$employeename.'/'.$filename)}}" frameborder="0" style="width: 800px; height:600px"></iframe>
               </div>
        </div>
    </div>
