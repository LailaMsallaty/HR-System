    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                ...
                <li  class="breadcrumb-item active"><a href="{{route('employeesalary.create')}}">{{trans('salaries-trans.Pay_Salary')}}</a></li>
               </ol>
        </div>
    </div>
</div>
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            <br>
                <form action="{{ route('employeesalary.store') }}" method="POST"  id="idForm">
                        @csrf
                        <h6 style="font-family: 'Cairo', sans-serif;color: #008080">{{trans('salaries-trans.Pay_Salary')}}</h6><br>
                 <div class="row">
                   <div class="col">
              ...
              <br>
               ...
               <div class="row">
                <div class="col">
                    ...
                    <input type="number" name="taxes"  class="form-control form-control-lg">
                </div>
                <div class="col">
                    <label for="insurance"
                    class="control-label">{{ trans('salaries-trans.Insurance') }} :  <span class="text-danger">%/*</span></label>
                    <input type="number" name="insurance"  class="form-control form-control-lg">
                </div>
                <div class="col">
                    <label for="Bonus"
                    class="control-label">{{ trans('salaries-trans.Bonus') }} : <span class="text-danger">%</span></label>
                    <input type="number" name="Bonus"  class="form-control form-control-lg">
                </div>
