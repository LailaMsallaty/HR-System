...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0" style="font-family: 'Cairo', sans-serif;color: green"> {{trans('salaries-trans.Edit_Advance_To')}} {{ $Employee->FName }}  {{ $Employee->LName }}</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                ...
                <li class="breadcrumb-item active">
                    <a href="{{ url('edit_employee_advance')}}/{{$AdvancePayment->id}}/{{ $Employee->id }}">{{trans('salaries-trans.Edit_Advance_To')}} {{ $Employee->FName }}  {{ $Employee->LName }}</a>
                </li>
            </ol>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12 mb-30">
            ...
            <div class="col-xs-12">
                <div class="col-md-12">
                    <br>
                    <form action="{{ route('Update_Advance') }}" method="POST">
                        @csrf
                         <div class="row">
                             <div class="col">
                                <label for="loan"
                                ...
                                <input id="Advance" type="number" name="advance"
                                       class="form-control" value="{{ $AdvancePayment->Advance_Amount }}"
                                       required>
                                <input id="id" type="hidden" name="id" class="form-control"
                                value="{{$AdvancePayment->id}}"  >
                                <input id="id" type="hidden" name="empid" class="form-control"
                                value="{{$Employee->id}}"  >
                         ...
                         <div class="row">
                             <div class="col">
                                ...
                                <textarea id="statement" type="text" class="form-control"
                                       name="statement" required> {{ $AdvancePayment->Statement }} </textarea>
