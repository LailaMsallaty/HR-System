...
@section('css')
    @toastr_css
@section('title')
    {{ trans('employees-trans.accept_Resign') }}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0"> {{trans('employees-trans.accept_Resign')}}</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}" class="default-color">{{trans('main-trans.Home')}}</a></li>
                <li  class="breadcrumb-item active"><a href="{{route('resigned.create')}}">{{trans('employees-trans.accept_Resign')}}</a></li>
               </ol>
        </div>
    </div>
</div>
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            <br>
                <form action="{{ route('resigned.store') }}" method="POST"  id="idForm">
                        @csrf
                        <h6 style="font-family: 'Cairo', sans-serif;color: #008080">{{trans('employees-trans.accept_Resign')}}</h6><br>
                 <div class="row">
                   <div class="col">
                            <label for="location_id"   class="control-label"> {{ trans('locations-trans.Location') }}  <span class="text-danger">*</span></label>
                            <select  class="form-control form-control-lg custom-select"
                            onclick="console.log($(this).val())" required
                   ...
                   <div class="col">
                    ...
                    <select name="department_id" required  class="form-control form-control-lg" class="custom-select"  onclick="console.log($(this).val())">
                    </select>
                    </div>
                    ...
                    <div class="col">
                        ...
                        <select name="employee_id" required  class="form-control form-control-lg" class="custom-select" >
                        </select>
                      </div>
              </div>
              <br>
