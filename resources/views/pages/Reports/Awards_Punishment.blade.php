...
@section('css')
    @toastr_css
@section('title')
    {{ trans('reports-trans.Awards_Punishments') }}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0"> {{trans('reports-trans.Awards_Punishments')}}</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}" class="default-color">{{trans('main-trans.Home')}}</a></li>
                <li  class="breadcrumb-item active"><a href="{{route('Awards_Punishments')}}">{{trans('reports-trans.Awards_Punishments')}}</a></li>
            </ol>
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="card-panel ">
        <div class="card-panel ">
            ...
            <form action="{{route('AwardsPunishmentsReports')}}" method="POST"  enctype="multipart/form-data">
                @csrf
             <div class="form-group">
                <div class="row ">
                    ...
                    @if (!isset($Selection) && !isset($Punishments))
                    <div class="col">

                        <label for="Award"><strong>{{trans('awards-trans.Award_type')}} : </strong></label>
                        <select required  type="date" name="Award" class="form-control form-control-lg "  id="award">
                            @foreach($all_Award as $award)
                    ...
                    <div class="col">
                        <label for="Punishment"><strong>{{trans('employees-trans.Punishment_Name')}} : </strong></label>
                        <select required type="date" name="Punishment" class="form-control form-control-lg "  id="punishment">
                    ...
                    <div class="col">
                        ...
                        <select required type="date" name="selection" class="form-control form-control-lg "  id="selection">
                            <option value="1">{{trans('reports-trans.Awards')}}</option>
                            <option value="2">{{trans('reports-trans.Punishments')}}</option>
                        </select>
...
@include('pages.Reports.PunishmentsSearch')
